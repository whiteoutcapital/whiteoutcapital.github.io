...
Whiteout Capital is a publication of Eudemonia 0x1 LLC, a Wyoming limited liability company registered to do business in the State of Colorado. The content provided on this website, newsletter, or any affiliated platforms (collectively, the “Service”) is for informational and educational purposes only. Nothing contained herein should be interpreted as personalized investment advice, a recommendation to buy, hold or sell securities, or an offer or solicitation to transact in any financial instrument.
...
Nothing in the Service should be interpreted as a recommendation to take any specific investment action or to buy, sell, or hold any security.
...
Any performance figures or return calculations presented are based on internal estimates and are not audited. Returns may assume entry at or near the time of publication and may not reflect actual trading conditions or the ability of any investor to replicate such trades. Performance figures do not account for transaction costs, taxes, slippage, liquidity constraints, or position sizing. Not all positions, writeups, or outcomes may be included in performance summaries. Past performance is not indicative of future results.
...
The author and affiliated entities may benefit from price movements in the securities discussed, including movements that may occur following publication of content.
